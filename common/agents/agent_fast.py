...
class Agent(BaseAgent,Game):
    ...
    def nearest_dropoff(self,Ox,Oy):
        ...
        Ox, Oy are the coordinates of our train
        Returns the coordinates of the nearest dropoff zone (tuple) and the "importance" (int)
        """
    ...
    def what_to_collect(self,Ox,Oy):
        ...
        Ox, Oy are the coordinates of our train
        Returns either the coordinates of the nearest dropoff zone or the coordinates of the nearest passenger (tuple)
